...
function preload(){
  ...
  heartLose = loadSound("sounds/HeartLose.mp3")

  heart1IMG = loadAnimation("img/1 Heart.png")
  heart2IMG = loadAnimation("img/2 Heart.png")
  heart3IMG = loadAnimation("img/3 Heart.png")
}
...
heart1 = createSprite(100,25,20,10);
heart1.addAnimation("hImg", heart1IMG)
heart1.scale = 0.3;
heart1.visible = false;

heart2 = createSprite(100,25,20,10);
heart2.addAnimation("hImg", heart2IMG)
heart2.scale = 0.3;
heart2.visible = false;

heart3 = createSprite(100,25,20,10);
heart3.addAnimation("hImg", heart3IMG)
heart3.scale = 0.3;
